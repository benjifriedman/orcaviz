...
2. Human detections (labels from community scientists listening live via the [Orcasound web app](https://live.orcasound.net/))
...
1. Subscriber list (Google form survey responses via notification banner at top of v2 [live.orcasound.net](https://live.orcasound.net/))
2. User feedback (e.g. Google form survey responses via Feedback button at bottom of v2 [live.orcasound.net](https://live.orcasound.net/))
...
* [OrcaHello REST API](https://aifororcasdetections.azurewebsites.net/swagger/index.html) (machine detection candidates, raw and moderated; Azure-hosted CosmosDB)
